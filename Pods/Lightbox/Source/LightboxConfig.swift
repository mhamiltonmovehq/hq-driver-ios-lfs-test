...
open class LightboxConfig {
  ...
  public struct PageIndicator {
    ...
    public static var textAttributes = [
      ...
      convertFromNSAttributedStringKey(NSAttributedString.Key.foregroundColor): UIColor(hex: "899AB8"),
      convertFromNSAttributedStringKey(NSAttributedString.Key.paragraphStyle): {
  ...
  public struct DeleteButton {
    ...
    public static var textAttributes = [
      convertFromNSAttributedStringKey(NSAttributedString.Key.font): UIFont.boldSystemFont(ofSize: 16),
      convertFromNSAttributedStringKey(NSAttributedString.Key.foregroundColor): UIColor(hex: "FA2F5B"),
      convertFromNSAttributedStringKey(NSAttributedString.Key.paragraphStyle): {
        var style = NSMutableParagraphStyle()
        style.alignment = .center
        return style
  ...
  public struct InfoLabel {
    ...
    public static var textAttributes = [
      convertFromNSAttributedStringKey(NSAttributedString.Key.font): UIFont.systemFont(ofSize: 12),
      convertFromNSAttributedStringKey(NSAttributedString.Key.foregroundColor): UIColor(hex: "DBDBDB")
    ]
  }
