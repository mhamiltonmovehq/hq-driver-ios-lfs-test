...
open class HeaderView: UIView {
  ...
  open fileprivate(set) lazy var closeButton: UIButton = { [unowned self] in
    let title = NSAttributedString(
      ...
      attributes: convertToOptionalNSAttributedStringKeyDictionary(LightboxConfig.CloseButton.textAttributes))
  ...
  open fileprivate(set) lazy var deleteButton: UIButton = { [unowned self] in
    let title = NSAttributedString(
      ...
      attributes: convertToOptionalNSAttributedStringKeyDictionary(LightboxConfig.DeleteButton.textAttributes))
