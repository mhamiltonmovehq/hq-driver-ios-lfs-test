...
@implementation FavoriteItemController 

@synthesize allItems, keys, favorites;
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    NSMutableArray *items = (NSMutableArray*)[del.surveyDB getAllItems:true withCustomerID:del.customerID];
...
- (void)hideChecked:(id)sender
{
    ...
    UIActionSheet *sheet = [[UIActionSheet alloc] initWithTitle:@"Are you sure that you would like to add the selected items to the favorite items list?"
                                                       delegate:self
...
-(void)actionSheet:(UIActionSheet*)actionSheet didDismissWithButtonIndex:(NSInteger)buttonIndex
{
    if(buttonIndex != [actionSheet cancelButtonIndex])
    {
        ...
        [del.surveyDB removeAllPVOFavoriteItems];
