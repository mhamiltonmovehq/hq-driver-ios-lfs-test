...
#define BASIC_INFO_ESTIMATED_WEIGHT 4
...
#define BASIC_INFO_OFFICE_PHONE 10
#define BASIC_INFO_MOBILE_PHONE 11
#define BASIC_INFO_HOME_PHONE 12
#define BASIC_INFO_PVO_SYNC 13
#define BASIC_INFO_PVO_VIEW_SURVEY 14
#define BASIC_INFO_ACCOUNT 15
#define BASIC_INFO_PVO_VIEW_PACKER_INVENTORY 16
#define BASIC_INFO_LANGUAGE 17
#define BASIC_INFO_INVENTORY_TYPE 18
#define BASIC_INFO_PVO_VIEW_PACK_SUMMARY 19
...
@property (nonatomic,strong) SurveyPhone *officePhone;
@property (nonatomic,strong) SurveyPhone *mobilePhone;
@property (nonatomic,strong) SurveyPhone *homePhone;
