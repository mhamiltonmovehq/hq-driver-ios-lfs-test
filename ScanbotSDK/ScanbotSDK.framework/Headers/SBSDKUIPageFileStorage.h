...
/**
 * A class for storing and restoring images in a memory-efficient way.
 ...
 * Values must be between 0 (high compression, small filesize, bad quality)
 * and 100 (no compression, huge filesize, good image quality).
