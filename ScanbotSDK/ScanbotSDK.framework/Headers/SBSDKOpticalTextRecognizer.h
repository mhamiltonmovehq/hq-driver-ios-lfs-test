 ...
 * file without any subfolders in a resource bundle named 'ScanbotSDKOCRData.bundle'.
 * Make sure that this bundle is copied along with your resources into your app.
 * Language files can be downloaded here https://github.com/tesseract-ocr/tesseract/wiki/Data-Files
 *
