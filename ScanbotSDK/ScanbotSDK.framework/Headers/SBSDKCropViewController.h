 ...
 *
 * Deprecated! Use `SBSDKImageEditingViewController`and `SBSDKImageEditingViewControllerDelegate`instead!
 */
 ...
 *
 * Deprecated! Use `SBSDKImageEditingViewController`instead!
 */
__attribute__ ((deprecated))
