...
/** Preferred aspect ratios for detector. Calculated by dividing image height with width, or vice versa.
 ...
 * Default is nil.
 */
@property(nonatomic, strong, nullable) NSArray<NSNumber *> *preferredAspectRatios;
 ...
 * Default is nil.
 */
@property (nonatomic, strong, nullable) NSArray<AVMetadataObjectType> *acceptedMachineCodeTypes;
