 ...
 */
- (void)scanningViewController:(nonnull SBSDKUIDocumentScannerViewController *)viewController
                     didFinish:(nonnull NSArray<SBSDKUIPage *> *)pages __attribute__((deprecated("Please use scanningViewController:didFinishWithDocument:.")));

@end

/**
 * A configurable view controller for camera based document scanning. 
 ...
 */
@interface SBSDKUIDocumentScannerViewController : SBSDKUIViewController
